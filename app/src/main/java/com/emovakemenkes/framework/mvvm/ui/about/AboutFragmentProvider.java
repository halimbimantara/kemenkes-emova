...
package com.emovakemenkes.framework.mvvm.ui.about;
...
public abstract class AboutFragmentProvider {
    ...
    @ContributesAndroidInjector
    abstract MainMenuFragment provideMainMenuFragmentFactory();

    @ContributesAndroidInjector
    abstract NotificatiobFragment provideNotificationFragmentFactory();
}
