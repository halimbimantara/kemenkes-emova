...
package com.emovakemenkes.framework.mvvm.data;
...
import com.emovakemenkes.framework.mvvm.data.local.db.DbHelper;
import com.emovakemenkes.framework.mvvm.data.local.prefs.PreferencesHelper;
...
import com.emovakemenkes.framework.mvvm.data.model.db.Option;
import com.emovakemenkes.framework.mvvm.data.model.db.Question;
import com.emovakemenkes.framework.mvvm.data.model.db.User;
import com.emovakemenkes.framework.mvvm.data.model.others.QuestionCardData;
import com.emovakemenkes.framework.mvvm.data.remote.ApiHeader;
import com.emovakemenkes.framework.mvvm.data.remote.ApiHelper;
import com.emovakemenkes.framework.mvvm.utils.AppConstants;
...
public class AppDataManager implements DataManager {
    ...
    public String getAccessRole() {
        return mPreferencesHelper.getAccessRole();
    }

    @Override
    public void setAccessRole(String accessRole) {
        mPreferencesHelper.setAccessRole(accessRole);
    }

    @Override
    public String getKodeProv() {
        return mPreferencesHelper.getKodeProv();
    }

    @Override
    public void setKodeProv(String kdprov) {
        mPreferencesHelper.setKodeProv(kdprov);
    }

    @Override
    public String getKodeKabKot() {
        return mPreferencesHelper.getKodeKabKot();
    }

    @Override
    public void setKodeKabKot(String kodeKabKot) {
        mPreferencesHelper.setKodeKabKot(kodeKabKot);
    }
    ...
    public Single<LoginResponseEmova> Login(LoginRequestEmova requestEmova) {
        return mApiHelper.Login(requestEmova);
    }

    @Override
    public Single<ResponseListPuskesmas> getListPuskesmas(int page, String KD_PROV, String KD_KABKOT) {
        return mApiHelper.getListPuskesmas(page, KD_PROV, KD_KABKOT);
    }
    ...
    @Override
    public void updateUserInfoSession(int NIP, LoggedInMode loggedInMode, String userName, String userAccess, String email, String profilePicPath, String KD_PROV, String KD_KABKOT) {
            long id=(long)NIP;
            setCurrentUserId(id);
            setAccessRole(userAccess);
            setKodeKabKot(KD_KABKOT);
            setKodeProv(KD_PROV);
            setCurrentUserLoggedInMode(loggedInMode);
            setCurrentUserName(userName);
            setCurrentUserEmail(email);
