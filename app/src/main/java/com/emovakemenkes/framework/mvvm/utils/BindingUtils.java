...
package com.emovakemenkes.framework.mvvm.utils;
...
import com.emovakemenkes.framework.mvvm.ui.feed.blogs.BlogAdapter;
import com.emovakemenkes.framework.mvvm.ui.feed.opensource.OpenSourceAdapter;
import com.emovakemenkes.framework.mvvm.ui.feed.opensource.OpenSourceItemViewModel;
import com.emovakemenkes.framework.mvvm.ui.main.MainViewModel;
import com.emovakemenkes.framework.mvvm.ui.main.QuestionCard;
...
public final class BindingUtils {
    ...
    @BindingAdapter({"adapter"})
    public static void listPuskesmas(RecyclerView recyclerView, List<ModelListPuskesmas> model) {
        AdapterPuskesmas adapter = (AdapterPuskesmas) recyclerView.getAdapter();
        if (adapter != null) {
            adapter.clearItems();
